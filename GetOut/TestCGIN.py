...
class TestGIN(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        X1 = np.random.uniform(0.5, 2.0) * np.log2(L1+1) + np.random.uniform(-1, 1, size=sample_size) ** 5

        X2 = np.random.uniform(0.5, 2.0) * L1 + np.random.uniform(-1, 1, size=sample_size) ** 5
        X3 = np.random.uniform(0.5, 2.0) * np.log2(L1+1)+ np.random.uniform(-1, 1, size=sample_size) ** 5

        X4 = np.random.uniform(0.5, 2.0) * L1 + np.random.uniform(-1, 1, size=sample_size) ** 5
        ...
        data = np.array([X1, X2, X3, X4, X7, X8]).T
